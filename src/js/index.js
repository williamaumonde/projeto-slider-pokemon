...
OBJETIVO 1 - quando clicarmos na seta de avançar, mostrar o próximo cartão da lista
    - passo 1 - dar um jeito de pegar o elemento HTML da seta avancar
    - passo 2 - identificar o clique do usuário na seta avançar
    - passo 3 - fazer aparecer o próximo cartão da lista (utilizando a classe "selecionado")
